...
/*   Updated: 2024/06/03 17:22:57 by angomes-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../include/cub3d.h"

void drawHorizontalLine(mlx_image_t *img, int x1, int x2, int y, unsigned int color) {
    for (int x = x1; x <= x2; x++) {
...
void fillCirclePoints(mlx_image_t *img, int xc, int yc, int x, int y, unsigned int color) {
...
void draw_circle(mlx_image_t *img, t_vec vec, unsigned int color) {
    ...
    int r = (radius_x < radius_y) ? radius_x : radius_y;
